...
await using var f = File.Create("label_print.png");
padded.SaveAsPng(f, new PngEncoder { CompressionLevel = PngCompressionLevel.BestCompression });
Console.WriteLine($"Saved label_print.png  ({padded.Width}×{padded.Height}px — portrait, sent to driver)");
